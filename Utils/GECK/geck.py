...
def call_function(file_path, function_name, *args, **kwargs):
    ...
    try:
        ...
        print(f"Error calling function '{function_name}' from file '{file_path}': {e_error}")
...
choice = int(Prompt.ask("Choose wich tool do you want to load:", choices=available_choices)) - 1
